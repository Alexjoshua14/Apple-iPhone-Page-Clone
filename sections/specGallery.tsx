...
const SpecGallery = () => {
  ...
  return (
    <div className="flex justify-center h-max md:h-[124rem] lg:h-[170rem] py-10 border-2 border-yellow-500">
      <div className="w-[400px] flex flex-col h-full justify-center
                      md:w-[700px] md:grid grid-cols-5 gap-6 md:gap-2 grid-rows-8
                      lg:w-[1000px]
      ">
